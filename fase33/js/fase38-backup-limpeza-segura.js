/* ======================================================================
   TABULEIRO ARENA - FASE 38 BACKUP E LIMPEZA SEGURA
   ...
   ====================================================================== */
(function fase38BackupLimpezaSegura() {
    if (window.__TA_FASE38_BACKUP_LIMPEZA_SEGURA__) return;
    window.__TA_FASE38_BACKUP_LIMPEZA_SEGURA__ = true;
    ...
    function updateVisiblePhaseTexts() {
        ...
        if (hubBadge) hubBadge.textContent = 'Fase 38';

        const replacements = [
            [/Fase\s*36(?:\.\d+)?/gi, 'Fase 38'],
    ...
    document.addEventListener('click', () => setTimeout(applyPhase38Safe, 80), true);
    document.addEventListener('DOMContentLoaded', applyPhase38Safe);
    window.addEventListener('load', applyPhase38Safe);
